...
def train_model(
    ...
    # Додаємо weight_decay для регуляризації
    ...
    for epoch in range(num_epochs):
        ...
        msg = f"Epoch {epoch+1}/{num_epochs} | Loss: {train_loss:.4f} | Val Acc: {val_acc:.4f} | LR: {current_lr:.6f}"
        print(msg)  # з'явиться миттєво в терміналі
        logger.info(msg)
